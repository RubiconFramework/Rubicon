...
{
	/*	Handles notes behaviour, like going out of bounds,
		getting hit and allat.	*/
	...
	public void NoteHit(Note note)
	{
		...
		//^ this is temporal until i make the hit events work,
		//then it will be moved to GameplayHud or GameplayBase
